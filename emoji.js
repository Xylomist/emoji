...
emojiList.forEach((item)=>{
    if(item.description===searchvalue||item.aliases.includes(searchvalue)||item.category===searchvalue||item.tags.includes(searchvalue)||!searchvalue){
    let emodiv=document.createElement("div");
    emodiv.classList.add("emoji");
    let emospan=document.createElement("span");
    emospan.innerHTML=item.emoji;
    emodiv.appendChild(emospan);
    container.appendChild(emodiv);
    }
});
}
